...
ActiveRecord::Schema.define(:version => 20120530182315) do

  create_table "bcms_polling_poll_responses", :force => true do |t|
    t.text    "answer"
    t.integer "votes",   :default => 0
    t.integer "poll_id"
  end

  create_table "bcms_polling_poll_versions", :force => true do |t|
  ...
  create_table "bcms_polling_polls", :force => true do |t|
    t.integer  "version"
