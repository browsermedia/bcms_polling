SPEC = Gem::Specification.new do |spec| 
  spec.name = "bcms_polling"
  spec.rubyforge_project = spec.name
  spec.version = "1.0.0"
  spec.summary = "A Polling Module for BrowserCMS"
  ...
  spec.files += Dir["lib/bcms_polling.rb"]
  spec.files += Dir["lib/bcms_polling/*"]
  spec.files += Dir["rails/init.rb"]
  spec.files += Dir["public/bcms/polling/**/*"]
  spec.has_rdoc = true
